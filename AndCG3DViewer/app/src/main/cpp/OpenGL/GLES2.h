...
class DrawInfo {
public:
    std::vector<CG3DVector3> mVirtexs;       /* 頂点情報 */
    std::vector<CG3DVector3> mNormals;       /* 法線情報 */
...
private:
    GlRenderData():mModelMatrix(),mVpMatrix(),mMvpMatrix(),mNormalMatrix(),mTouchAngleX(0),mTouchAngleY(0),mTexId(0),mGlShaderObjs(),mGlBufferObj(){}
