...
const std::map<std::pair<std::string, std::string>, std::tuple<std::pair<std::int64_t, std::int64_t>, std::pair<std::int64_t, std::int64_t>, std::pair<std::int64_t, std::int64_t>>>
RIGHT_HAND_AXES = {
...
const std::map<std::tuple<std::pair<std::int64_t, std::int64_t>, std::pair<std::int64_t, std::int64_t>, std::pair<std::int64_t, std::int64_t>>, std::pair<std::string, std::string>>
RIGHT_HAND_AXES_RR = {
//	Up, Forward->FBX values(tuples of(axis, sign), Up, Front, Coord).
	{{{0,  1}, {1,  1}, {2,  1} }, { "X","-Y"}},
	{{{0,  1}, {1, -1}, {2, -1} }, { "X", "Y"}},
	...
	{{{2,  1}, {0, -1}, {1, -1} }, { "Z", "X"}},
	{{{2,  1}, {1,  1}, {0, -1} }, { "Z","-Y"}},
	{{{2,  1}, {1, -1}, {0,  1} }, { "Z", "Y"}},	/* Blender system! */
	{{{2, -1}, {0,  1}, {1, -1} }, {"-Z","-X"}},
	{{{2, -1}, {0, -1}, {1,  1} }, {"-Z", "X"}},
	{{{2, -1}, {1,  1}, {0,  1} }, {"-Z","-Y"}},
	{{{2, -1}, {1, -1}, {0, -1} }, {"-Z", "Y"}},
